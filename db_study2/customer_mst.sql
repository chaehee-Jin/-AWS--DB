...
2. 드래그한 영억만 실행 -> 드래그 + ctrl + shift + enter
3. 쿼리 에디터 전체 실행 -> ctrl+ suhift + enter

*/

insert into customer_mst values(1, "김준일", "부산동래구 사직동");
insert into customer_mst values(2, "고병수", "부산진구 가야동");
insert into customer_mst values(3, "손민재", "부산 남구 대연동");

select * from customer_mst;

insert into product_mst values (1, "아이폰 13", 1000000);
insert into product_mst values (2, "아이폰 14", 1100000);
insert into product_mst values (3, "아이폰 15", 1200000);
