...
--
-- Table structure for table `lecturer_registe_mst`
--

DROP TABLE IF EXISTS `lecturer_registe_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lecturer_registe_mst` (
  `id` int NOT NULL AUTO_INCREMENT,
  `lecture_id` int NOT NULL,
...
--
-- Dumping data for table `lecturer_registe_mst`
--

LOCK TABLES `lecturer_registe_mst` WRITE;
/*!40000 ALTER TABLE `lecturer_registe_mst` DISABLE KEYS */;
/*!40000 ALTER TABLE `lecturer_registe_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-07 17:46:10
